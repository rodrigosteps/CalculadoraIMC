...
const altura = parseFloat(alturaComVirgula.replaceAll(',', '.')); // Altura convertida e corrigida

const pesoComVirgula = document.getElementById('peso').value; // Pega o valor do peso
const peso = parseFloat(pesoComVirgula.replaceAll(',', '.')); // Peso convertido e corrigido!
// ------------------------------------------
...
resultado.textContent = 'Preencha todos os campos corretamente (Nome, Altura e Peso).';
}
